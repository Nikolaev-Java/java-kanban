...
class HistoryManagerTest {
    ...
    void initHistory(){
        ...
        task = new Task("Task-01", "Task-01 desc",1, StatusOfTasks.NEW);
        epic = new Epic("Epic-01", "Epic-01 desc",2);
        subTask = new SubTask("SubTask-01", "SubTask-01 desc",3, StatusOfTasks.NEW, 2);
    }
    @Test
